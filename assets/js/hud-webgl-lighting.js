...
function init() {
  ...
  const brick = loadTexture(`/assets/images/textures/invent-box.jpg`);
  ...
  (function shaderProgram() {
    ...
    const vec3 lightDirection = vec3(0, 1.0, 1.0);
  ...
  // ANIMATION LOOP
  // ==============
    mat4.rotateX(modelMatrix, modelMatrix,  0.45);
    // mat4.rotateZ(modelMatrix, modelMatrix,  0.5);
